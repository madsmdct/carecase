...
void loop() {
  ...
  if((digitalRead(17) == HIGH))  // If A3 = 2.5V or higher
  {  delay(255);             // wait 0,1sec
    lcd.clear();              // clear lcd
    delay(10);              // wait 1 sec
    lcd.print("    TESTING");     // Print Testing on LCD
    delay(255);              // wait 1 sec
  ...
  selectPort(1);
   ...
   {
     lcd.clear();
     lcd.print("   FEJLKODE-1");
     Serial.print("FEJLKODE-1");
     Serial.print("\n");
     waitbutton();
  ...
  selectPort(2);
   ...
   {
     lcd.clear();
     lcd.print("   FEJLKODE-2");
     Serial.print("FEJLKODE-2");
     Serial.print("\n");
     waitbutton();
 ...
 selectPort(3);
   ...
   {
     lcd.clear();
     lcd.print("   FEJLKODE-3");
     Serial.print("FEJLKODE-3");
     Serial.print("\n");
     waitbutton();
  ...
  selectPort(4);
   ...
   {
     lcd.clear();
     lcd.print("   FEJLKODE-4");
     Serial.print("FEJLKODE-4");
     Serial.print("\n");
     waitbutton();
